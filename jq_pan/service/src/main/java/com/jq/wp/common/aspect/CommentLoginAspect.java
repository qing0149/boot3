...
/**
 * @program: Boot3
 * @description:统一的登录拦截切面逻辑实现类
 * @author:
 * @create: 2024-03-09 10:09
 **/
@Component
@Aspect
@Slf4j
public class CommentLoginAspect {
    /**
     * 登录认证参数名称
     */
     ...
     * 切点表达式
     */
    private final static String POINT_CUT = "* com.jq.wp.*.controller..*(..)";
    @Autowired
    ...
    private void saveUserId(Object userId) {
        UserIdUtils.set(Long.valueOf(String.valueOf(userId)));
    }
